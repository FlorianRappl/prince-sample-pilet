import TheShadow from '../assets/music/15_The_Shadow.mp3';
import Float from '../assets/music/16_Float.mp3';
import Jaffar2 from '../assets/music/19_Jaffar_2.mp3';
import JaffarDead from '../assets/music/20_Jaffar_Dead.mp3';
import HeroicDeath from '../assets/music/13_Heroic_Death.mp3';
import levels from '../assets/maps/all.codegen';
...
PrinceJS.Game.prototype = {
  preload: function () {
    this.game.load.audio("TheShadow",TheShadow);
    this.game.load.audio("Float", Float);
    this.game.load.audio("Jaffar2", Jaffar2);
    this.game.load.audio("JaffarDead", JaffarDead);
    this.game.load.audio("HeroicDeath", HeroicDeath);

    const name = `level${PrinceJS.currentLevel}`;
    this.load.json("level", levels.find((res) => res.name === name)?.path);
  },
