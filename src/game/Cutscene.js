import cover from '../assets/gfx/cover.png';
import Princess from '../assets/music/03_Princess.mp3';
import Jaffar from '../assets/music/04_Jaffar.mp3';
import Heartbeat from '../assets/music/05_Heartbeat.mp3';
import Heartbeat2 from '../assets/music/12_Heartbeat_2.mp3';
import Timer from '../assets/music/17_Timer.mp3';
import Embrace from '../assets/music/21_Embrace.mp3';
import TragicEnd from '../assets/music/18_Tragic_End.mp3';
import cutscenes from '../assets/cutscenes/all.codegen';
...
PrinceJS.Cutscene.prototype = {
  preload: function () {
    this.game.load.image('cover', cover);
    switch (PrinceJS.currentLevel) {
      case 1:
        this.game.load.audio('Princess', Princess);
        this.game.load.audio('Jaffar', Jaffar);
        this.game.load.audio('Heartbeat', Heartbeat);
        break;
      case 2:
      case 4:
      case 6:
      case 12:
        this.game.load.audio('Heartbeat2', Heartbeat2);
        break;
      case 8:
      case 9:
        this.game.load.audio('Timer', Timer);
        break;
      case 15:
        this.game.load.audio('Embrace', Embrace);
        break;
      case 16:
        this.game.load.audio('TragicEnd', TragicEnd);
        break;
    }
    const name = `scene${PrinceJS.currentLevel}`;
    this.load.json('cutscene', cutscenes.find((res) => res.name === name)?.path);
  },
